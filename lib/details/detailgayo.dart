...
class detailgayo extends StatefulWidget {
  final imgPath, headerColor;

  detailgayo({this.imgPath, this.headerColor});

  @override
  _detailgayoState createState() => _detailgayoState();
}

class _detailgayoState extends State<detailgayo> {
  @override
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Coffea Gayo, also known as the Arabian coffee, is a species of flowering plant in the coffee and madder family Rubiaceae. It is believed to be the first species of coffee to have been cultivated, and is currently the dominant cultivar, representing about 60% of global production.',
                        style: GoogleFonts.bigShouldersText(

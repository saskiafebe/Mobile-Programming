...
class detailliberica extends StatefulWidget {
  final imgPath, headerColor;

  detailliberica({this.imgPath, this.headerColor});

  @override
  _detaillibericaState createState() => _detaillibericaState();
}

class _detaillibericaState extends State<detailliberica> {
  @override
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Coffea Liberica, also known as the Arabian coffee, is a species of flowering plant in the coffee and madder family Rubiaceae. It is believed to be the first species of coffee to have been cultivated, and is currently the dominant cultivar, representing about 60% of global production.',
                        style: GoogleFonts.bigShouldersText(

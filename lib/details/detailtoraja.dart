...
class detailtoraja extends StatefulWidget {
  final imgPath, headerColor;

  detailtoraja({this.imgPath, this.headerColor});

  @override
  _detailtorajaState createState() => _detailtorajaState();
}

class _detailtorajaState extends State<detailtoraja> {
  @override
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Coffea Toraja, also known as the Arabian coffee, is a species of flowering plant in the coffee and madder family Rubiaceae. It is believed to be the first species of coffee to have been cultivated, and is currently the dominant cultivar, representing about 60% of global production.',
                        style: GoogleFonts.bigShouldersText(

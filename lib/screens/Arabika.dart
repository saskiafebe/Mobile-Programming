...
import 'package:flutter_utskopi/details/details.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:smooth_star_rating/smooth_star_rating.dart';

class Arabika extends StatefulWidget {
  @override
  _ArabikaState createState() => _ArabikaState();
}

class _ArabikaState extends State<Arabika> {
  @override
  Widget build(BuildContext context) {
    return
      ...
      ListView(
        ...
        children: [
          buildListItem('assets/arabica.png', '150.000', ColorPalette().secondSlice),
          buildListItem('assets/arabica.png', '200.000', ColorPalette().firstSlice)
        ]
    );
  }

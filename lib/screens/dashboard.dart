...
import 'package:flutter_utskopi/screens/Arabika.dart';
import 'package:flutter_utskopi/screens/Robusta.dart';
import 'package:flutter_utskopi/screens/Liberika.dart';
import 'package:flutter_utskopi/screens/Gayo.dart';
import 'package:flutter_utskopi/screens/Toraja.dart';
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  List allOptions = [Arabika(), Robusta(), liberica(), gayo(), toraja()];
          ...
          children: [
            ...
            Positioned(
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text('A coffee a day a grumpy aways :)',
                      style: GoogleFonts.bigShouldersText(
        ...
        child: RotatedBox(
            ...
            child: Container(
                ...
                child: Row(
                    ...
                    children: [
                      buildOption('Arabika', 0),
                      buildOption('Robusta', 1),
                      buildOption('Liberika', 2),
                      buildOption('Gayo', 3),
                      buildOption('Toraja', 4),
                    ]))));
  }
